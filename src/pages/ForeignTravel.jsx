...
/* ── Fonts ── */
if (typeof document !== "undefined" && !document.getElementById("ft-fonts")) {
  const l = document.createElement("link");
  l.id = "ft-fonts"; l.rel = "stylesheet";
...
if (typeof document !== "undefined" && !document.getElementById("ft-fonts2")) {
  const l = document.createElement("link");
  l.id = "ft-fonts2"; l.rel = "stylesheet";
