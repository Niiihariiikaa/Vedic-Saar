...
useEffect(() => {
  const observer = new IntersectionObserver(
    ([entry]) => { if (entry.isIntersecting) setGlowing(true); },
    { threshold: 0.3 }
  );
  ...
  return (
    <div className="relative z-0 bg-[url('/assets/bg.png')] bg-cover bg-center bg-no-repeat" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
